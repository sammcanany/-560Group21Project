...
INSERT INTO Flights.Airport([Name], AirportCode, [Location])
VALUES
	('Hartsfield-Jackson International Airport', '1000', 'GA'),
	('Dallas/Fort Worth International Airport', '2000', 'TX'),
	('Denver International Airport','3000','CO'),
	('O''Hare International Airport','4000','IL'),
	('Los Angeles International Airport','5000','CA'),
	('Charlotte Douglas International Airport','6000','NC'),
	('Harry Reid International Airport','7000','NV'),
	('Phoenix Sky Harbor International Airport','8000', 'AZ'),
	('Orlando International Airport','9000', 'FL'),
	('Manhattan Regional Airport','9001', 'KS');
